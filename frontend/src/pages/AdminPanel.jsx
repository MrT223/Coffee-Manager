                ...
                {feedbacks.length === 0 ? (
                  ...
                  feedbacks.map(fb => (
                    <tr key={fb.id} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-[#1E3932] text-white border border-white/10">
                          {fb.category}
                        </span>
                      </td>
